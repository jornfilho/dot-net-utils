...
namespace DotNetUtils.tests.Converters.IntegerConverter
{
    ...
    public class FromString
    {
        ...
        public int ToIntegerFromStringValidNumbers(string stringValue, int defaultValue, char decimalSeparator, char milharSeparator)
        {
        ...
        public int ToIntegerFromStringInvalidNumbers(string stringValue, int defaultValue, char decimalSeparator, char milharSeparator)
        {
            return stringValue.ToInteger(defaultValue, decimalSeparator, milharSeparator);
        }
        ...
        [TestCase("111.111,11", 0, ',', '.', ExpectedResult = 111111)]
        [TestCase("1.111.111,11", 0, ',', '.', ExpectedResult = 1111111)]
        public int ToIntegerFromStringDifferentSeparators(string stringValue, int defaultValue, char decimalSeparator, char milharSeparator)
        {
            return stringValue.ToInteger(defaultValue, decimalSeparator, milharSeparator);
        }
        ...
        public int ToIntegerFromStringWithoutDefaults(string stringValue)
        {
